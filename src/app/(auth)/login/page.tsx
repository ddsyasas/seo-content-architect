...
function LoginForm() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            console.log('[Google Login] Redirect URL:', callbackUrl);
        ...
        <Card className="shadow-xl border-0 dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="pt-8 pb-6">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700"
                >
                    {isGoogleLoading ? (
