...
import type { LimitsData } from './page';

interface ProjectsPageContentProps {
    initialProjects: Project[];
    initialLimits: LimitsData;
}

/**
 * Client Component: Handles projects interactivity
 * - Search/filter
 * - Create/Edit/Delete modals
 * - CRUD operations
 */
export function ProjectsPageContent({ initialProjects, initialLimits }: ProjectsPageContentProps) {
    const [projects, setProjects] = useState<Project[]>(initialProjects);
    const [limits, setLimits] = useState<LimitsData>(initialLimits);
