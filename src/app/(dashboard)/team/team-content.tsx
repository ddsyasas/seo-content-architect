...
import {
    Users, Crown, Pencil, Eye,
    X, FolderKanban, ChevronDown, AlertCircle
} from 'lucide-react';
...
/**
 * Client Component: Handles team dashboard interactivity
 * - Role changes
 * - Project assignment toggles
 */
export function TeamDashboardContent({ initialData }: TeamDashboardContentProps) {
    ...
    const [currentUserEmail] = useState(initialData.currentUserEmail);
