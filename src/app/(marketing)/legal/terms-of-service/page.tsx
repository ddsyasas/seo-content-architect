        ...
        <MarketingLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">4. Subscription Plans and Payment</h2>
                    <p className="text-gray-600">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">6. Your Content</h2>
                    <p className="text-gray-600">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">8. Termination</h2>
                    <p className="text-gray-600">
