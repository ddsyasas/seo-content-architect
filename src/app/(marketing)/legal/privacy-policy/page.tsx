        ...
        <MarketingLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-600">We automatically collect certain information when you use SyncSEO:</p>
                    <ul className="list-disc pl-6 text-gray-600 space-y-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Data Sharing</h2>
