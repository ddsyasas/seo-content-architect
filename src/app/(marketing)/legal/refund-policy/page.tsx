        ...
        <MarketingLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">7-Day Money-Back Guarantee</h2>
                    <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-6 mt-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Eligibility</h2>
                    <p className="text-gray-600 dark:text-gray-300">To be eligible for a refund, you must:</p>
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">What&apos;s Covered</h2>
                    <div className="grid md:grid-cols-2 gap-6 mt-4">
                        <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-6">
                            <h3 className="font-semibold text-green-900 dark:text-green-300 mb-3">Eligible for Refund</h3>
                        ...
                        <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-6">
                            <h3 className="font-semibold text-red-900 dark:text-red-300 mb-3">Not Eligible for Refund</h3>
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">How to Request a Refund</h2>
                    <p className="text-gray-600 dark:text-gray-300">To request a refund:</p>
                    <ol className="list-decimal pl-6 text-gray-600 dark:text-gray-300 space-y-3 mt-4">
                        <li>
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Refund Processing</h2>
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Cancellation vs. Refund</h2>
                    <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-4">
                        ...
                        <Link href="/settings" className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300">
                            account settings
                        </Link>.
                    </p>

                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Free Plan</h2>
                    <p className="text-gray-600 dark:text-gray-300">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Questions?</h2>
                    <p className="text-gray-600 dark:text-gray-300">
