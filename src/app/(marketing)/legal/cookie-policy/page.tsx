        ...
        <MarketingLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-200">
                                    <th className="text-left py-2 text-gray-900 font-semibold">Service</th>
                                    <th className="text-left py-2 text-gray-900 font-semibold">Purpose</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-200">
                                <tr>
                                    <td className="py-3 text-gray-600">Google Analytics</td>
                                    <td className="py-3 text-gray-600">Website analytics and usage statistics</td>
                                </tr>
                                <tr>
                                    <td className="py-3 text-gray-600">Stripe</td>
                                    <td className="py-3 text-gray-600">Payment processing and fraud prevention</td>
                                </tr>
                                <tr>
                                    <td className="py-3 text-gray-600">Supabase</td>
                                    <td className="py-3 text-gray-600">Authentication and session management</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Google Analytics Opt-Out</h3>
                    <p className="text-gray-600">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Cookie Retention</h2>
                    <p className="text-gray-600">
